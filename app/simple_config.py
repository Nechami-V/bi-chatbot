...
class Config:
    ...
    USER_DB_URL = os.getenv("USER_DB_URL", "mssql+pyodbc://sa:YourPassword@localhost/YourDatabase?driver=ODBC+Driver+17+for+SQL+Server")
    
    # --- Users Database (SQL Server) ---
    USER_DATABASE_URL = os.getenv("USER_DATABASE_URL", "sqlite:///./data/users.db")  # Fallback to SQLite for development
